...
export function PopupPreview() {
  return (
    <figure
      role="img"
      aria-label="Das AudioRoute-Popup: der Tab „Konzert-Mitschnitt“ von youtube.com wird auf USB-Kopfhörer geroutet."
    ...
    >
      ...
      <div className="px-4.5 pt-4.5 pb-[7px]">
        <div className="mx-px mb-2.5 flex items-center justify-between">
          <p className="text-[9.5px] font-bold uppercase tracking-[.1em] text-ink-soft">Signalweg</p>
      ...
      <div className="px-4.5 pt-3.25 pb-3.75">
        <div className="grid min-h-12.5 grid-cols-[28px_minmax(0,1fr)_20px] items-center gap-2 rounded-xl border border-[#ff8d82]/25 surface-stop px-3.75 text-[12.5px] font-semibold text-[#e8f1ed] shadow-[inset_0_1px_0_rgb(255_255_255/5%)]">
          ...
          <span>Routing beenden</span>
          <span />
        </div>
        <p className="mt-2.5 text-center text-[10px] leading-[1.35] text-ink-soft">
          Läuft weiter, wenn du dieses Popup schließt.
        </p>
      </div>
